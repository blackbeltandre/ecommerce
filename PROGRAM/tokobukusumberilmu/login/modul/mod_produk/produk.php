...
switch($_GET[act]){
  ...
  default:
    echo "<h2>Tambah Buku</h2>
          <input type=button class='tombol' value='Tambahkan Buku' onclick=\"window.location.href='?module=produk&act=tambahproduk';\">
          <table>
          <tr><th>No</th><th>Nama Buku</th><th>Berat(kg)</th><th>Harga</th><th>Diskon</th><th>Stok</th><th>Tgl. Masuk</th><th>Aksi</th></tr>";
  ...
  case "tambahproduk":
    echo "<h2>Tambah Buku</h2>
          ...
          <table>
          <tr><td width=70>Nama Buku</td>     <td> : <input type=text name='nama_produk' size=60></td></tr>
  ...
  case "editproduk":
    ...
    echo "<h2>Edit Buku</h2>
          ...
          <table>
          <tr><td width=70>Nama Buku</td>     <td> : <input type=text name='nama_produk' size=60 value='$r[nama_produk]'></td></tr>
