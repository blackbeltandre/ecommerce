...
if ($_GET[module]=='store'){
     ...
     echo " 
            </div><div class='profil2'><b>Selamat Datang di Toko Buku Sumber Ilmu</b><br />
<p>Kami menyediakan berbagai macam jenis buku untuk segala kebutuhan anda. Mulai dari buku anak-anak, adat istiadat, it ,rohani dan lainnya.
Toko Buku Sumber Ilmu online, kami berusaha memanjakan sekaligus memudahkan para customer untuk berbelanja buku di toko online kami. Kenyamanan dan keamanan pun kami jaga sehingga tercipta hubungan baik penjual dan pembeli.
...
if ($_GET['module']=='profilkami'){
  ...
  echo "<h4 class='heading colr'>Profil Kami</h4>
          ...
          <div class='profil'>
              <div><p>Toko Sumber Ilmu adalah toko buku online, yang menyediakan segala kebutuhan buku anda. Toko Buku Sumber Ilmu ingin memberikan kemudahan kepada para calon pembeli, cara santai, mudah dan hemat dalam berbelanja buku bermanfaat dengan harga yang terjangkau.</p>

<p>Karena itulah website ini dibuat sedemikian sederhananya sehingga diharapkan dapat membantu para pengunjung untuk dapat menelusuri buku-buku yang ditawarkan secara lebih mudah.</p>

<p>Selain melayani pesanan produk-produk yang ada di toko online, kami menerima pembelian secara offline dengan datang ke toko kami yang ada di Jakarta.</p>

<p>Akhirnya, kami mengucapkan terima kasih atas kunjungan anda di Toko Buku Sumber Ilmu.</p></div>
...
elseif ($_GET[module]=='semuaproduk'){
  echo "<h4 class='heading colr'>Semua Buku</h4>";
...
elseif ($_GET[module]=='keranjangbelanja'){
  ...
  if($ketemu < 1){
    ...
    echo "<h4 class='heading colr'>Keranjang Belanja</h4>
          ...
          <tbody>
         <tr  background='images/bg_tab.jpg' align=center height=23><th><span class='table'>No</th><th><span class='table'>Foto</th><th><span class='table'>Nama Buku</th><th><span class='table'>Berat(Kg)</th><th><span class='table'>Qty</th>
...
elseif ($_GET['module']=='hasilcari'){
  ...
  if ($ketemu > 0){
  echo "<div class='table3'>Ditemukan <b>$ketemu</b> buku dengan kata <font style='background-color:#D5F1FF'><b>$kata</b></font> <b>:</b> </div>";
    ...
    echo "<p><div class='table3'>Tidak ditemukan buku dengan kata <font style='background-color:#D5F1FF'><b>$kata</b></p>
...
if ($_GET['module']=='selesaibelanja'){
  ...
  echo "<h4 class='heading colr'>Data Pembeli</h4>
     ...
     echo "<h4 class='heading colr'>Konfirmasi Keranjang Belanja Anda</h4>
          <table width=670 border=0 cellpadding=0 cellspacing=1 align=center>
          <tbody>
          <tr background='images/bg_tab.jpg' align=center height=23><th><span class='table'>No</th><th><span class='table'>Nama Buku</th><th><span class='table'>Berat(Kg)</th><th><span class='table'>Qty</th>
...
echo "<table width=600 border=0 cellpadding=0 cellspacing=1 align=center>
        <tr background='images/bg_tab3.jpg' align=center height=23><th><span class='table'>No</th><th><span class='table'>Nama Buku</th><th><span class='table'>Berat(Kg)</th><th><span class='table'>Qty</th><th><span class='table'>Harga</th><th><span class='table'>Sub Total</th></tr>";
...
$subjek="Pemesanan Online Toko Buku Sumber Ilmu";

// Kirim email dalam format HTML
$dari = "From: admin@gmail.com \n";
...
mail("developerpdak@gmail.com",$subjek,$pesan,$dari);
