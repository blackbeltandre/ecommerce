...
<meta http-equiv="Copyright" content="Andre">
...
<div id="wrapper_sec">
	<div id="head">
	  <div class="logo">
        	<a href="index.php"><strong><font size="8" color="white">Toko Buku Sumber<img src="images/ilmu.png" weight="60" height="60" alt="" /></font></strong></a>
      </div>
        <div class="rightnavi">
            <br><br><br><br>
          <div class="clear">
          <ul><SCRIPT language=JavaScript src="date.js"></SCRIPT> 
...
if (h < 11) { document.write('Selamat pagi, pengunjung...'); }
        ...
        <div class="navigation">
          <ul id="nav" class="dropdown dropdown-linear dropdown-columnar">
            ...
            <li><b><a href='semua-produk.html'>SEMUA BUKU</a></b></li>
    ...
    <div id="crumb">
        ...
        <ul class="search right"><form method="POST" action="hasil-pencarian.html">
            	<li><input name="kata" type="text" value="cari buku"  class="bar" /></li>
                  ...
                  <tr>
                    <td><div align="center"><span class="border_box">
                      <span class='bank'></a></div>
						...
						<div class='bank'><span class='bank'>an. Gandhi Unedo</span></div><br>
						<div class='bank'>
							 <img src='foto_banner/bni.gif' border='0' >
							 </a>
						 </div>
						<div class='bank'><span class='bank'>No. Rek : 987 654 321
						<div class='bank'><span class='bank'>an. Gandhi Unedo</span></div>
                    </span></div>
				</td>
                  </tr>
                </table>
    ...
    <div id="footer">
        <div class="aboutus">
        	<h5>Tentang Kami</h5>
        	<p>
            	Toko Buku Sumber Ilmu online, yang menyediakan segala kebutuhan buku-buku anda. Toko Buku Sumber Ilmu ingin memberikan kemudahan kepada para calon pembeli, cara santai, mudah dan hemat dalam berbelanja buku bermanfaat dengan harga yang terjangkau.</p>
            <a href="profil-kami.html" class="simplebtn">selanjutnya</a>
        </div>
        <div class="contactus">
        	<h5>Kontak Kami </h5>
            <ul>
            	<li class="tel"><span class="bold">Telp:</span> 0821-6323-6626 </li>
                <li class="email"><span class="bold">Email:</span> <a href="mailto:admin@gmail.com">tokosumberilmu@gmail.com</a></li>
                
            </ul>
        </div>
        <div class="clear"></div>
        <div class="copyright_network">
        	<p>Copyright ©<?php echo date('Y'); ?> by: <font color="red"><strong>Toko Buku Sumber Ilmu </font></strong>- Programming & All Content is watermarks by Developer : Gandhi Unedo</p>
			<ul class="network"><li>
